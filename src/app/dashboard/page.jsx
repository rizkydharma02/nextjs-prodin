              ...
              <TableBody>
                {products.map((product, index) => (
                  <TableRow key={product.id}>
                    ...
                    <TableCell>
                      {selectedEdit === product.id ? <Input type="number" name="price" value={newProduct.price} onChange={handleInputChange} placeholder="Harga Produk" required /> : product.price}
                    ...
                    <TableCell>
                      {selectedEdit === product.id ? <Input type="number" name="amount" value={newProduct.amount} disabled /> : product.amount}
                    ...
                    <TableCell>
                      {selectedEdit === product.id ? (
                        ...
                        <ButtonGroup>
                          <Button type="button" onClick={() => handleEditClick(product.id)} variant="contained" endIcon={<EditIcon />} sx={{ bgcolor: '#FFA41B', width: 100 }}>
                            Ubah
                          </Button>
                          <Button type="button" onClick={() => deleteProduct(product.id)} variant="contained" endIcon={<DeleteIcon />} color="error" sx={{ width: 100 }}>
                            Hapus
                          </Button>
                        </ButtonGroup>
                      )}
